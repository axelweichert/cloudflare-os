...
const NO_DEFAULT_CRED_INPUTS = new Set([
  ...
  "gatekeeper-unifi",         // users connect their own UniFi Site Manager API key in-app
  "gatekeeper-cloudflare",    // users connect their own Cloudflare API token in-app (OWL-1618)
]);
