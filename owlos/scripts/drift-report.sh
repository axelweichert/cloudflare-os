...
#
# Verwendung:
#   owlos/scripts/drift-report.sh              # gegen upstream/main
#   owlos/scripts/drift-report.sh --no-fetch   # ohne git fetch (offline / bereits gefetcht)
#   UPSTREAM_REF=upstream/main LOCAL_REF=main owlos/scripts/drift-report.sh
#
...
echo "  • Jede Entscheidung im Drift-Register eintragen: owlos/FORK-SYNC.md"
