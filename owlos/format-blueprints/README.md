...
node owlos/format-blueprints/build-blueprints.mjs

# 2) In das Worker-Bundle ziehen — der Fork zeigt FORMAT_BLUEPRINTS_DIR auf DIESES Verzeichnis:
cd packages/workshop-backend && FORMAT_BLUEPRINTS_DIR=../../owlos/format-blueprints \
...
```
npx tsx --test owlos/format-blueprints/blueprints.test.ts
```
