/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 65b2788b87e5cef22bc2fc27abd0a07f)
...
interface __BaseEnv_Env {
	...
	MAIL_SERVICE: Fetcher /* vonbusch-app-agentic-inbox */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/mailbox-gatekeeper");
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "UPSTREAM_MCP_URL" | "MAILBOX_ACL">> {}
}
